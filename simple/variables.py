...
damping = 0.9  # [ ? ] Damping of the system
...
"""
crane_mass = 1.55  # [kg] Mass of all this components
...
The origin of this coordinate system is located in the middle of the bottom of the crane base.
"""
counterweight_mass = 2.7  # [kg] Counterweight mass
